...
- `app/src/main/java/com/listeenb/reader/MainActivity.java`：主界面、书架、目录、阅读设置、搜索、书签、TTS 和进度恢复。
...
7. 选择“男声”或“女声”，点击“播放”开始听书，可暂停、继续或停止。
8. 退出后再次打开 App，会自动尝试恢复上次书籍、章节和阅读位置。
