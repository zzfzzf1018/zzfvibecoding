...
- 自动滚动同步：听书播放时根据朗读进度自动滚动当前章节。
- 自动保存每本书的 URI、章节、滚动位置、进度百分比和语音偏好。
- EPUB 元数据：读取标题、作者和封面图片。
- 全文搜索：在当前书籍章节内搜索关键词并跳转。
- 书签和笔记：为当前章节位置添加书签，可附加笔记并跳回原位置。
- 导入管理：支持选择文件夹批量导入 EPUB、重新扫描上次文件夹、从书架删除书籍记录。
...
7. 使用“管理”选择文件夹批量导入 EPUB、重新扫描上次文件夹，或删除书架中的书籍记录。
8. 选择“男声”或“女声”，点击“播放”开始听书，可在 App 内暂停/停止，也可锁屏后通过通知栏暂停/继续、下一章或停止。
9. 听书时 App 会按朗读进度自动滚动章节正文。
